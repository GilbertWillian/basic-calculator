...
describe('Calculadora', () => {
  ...
  it('deve limpar o campo de números', () => {
    ...
    fireEvent.click(getByText('2')); // Gera evento de Click campo com texto 2, ou seja, Button 2
    fireEvent.click(getByText('C')); // Gera evento de Click campo com texto C, ou seja, Button C
    expect(getByTestId('txtNumeros')).toHaveValue('0'); // Espera que o TestID 'textNumeros tenha valor 0;
  });
